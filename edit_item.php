...
<body>
    ...
    <div class="preview">
        ...
        <form class="add_new" method="POST" action="db_edit_item.php">
            <label for="item_name">Name</label>
            <input id="item_name" value="<?php echo($name)?>" name="item_name" maxlength="50" required>
            
            <label for="item_description">Description</label>
            <textarea id="item_description" style="resize: none; height: 5rem;" name="item_description" maxlength="255"><?php echo($description)?></textarea>
            
            <label for="item_photo">Image URL</label>
            <input id="item_photo" value="<?php echo($photo)?>" name="item_photo" maxlength="2083" required>

            <input type="hidden" name="item_id" value="<?php echo($item_id)?>">

            <input type="hidden" name="old_name" value="<?php echo($name)?>">
            <input type="hidden" name="old_description" value="<?php echo($description)?>">
            <input type="hidden" name="old_photo" value="<?php echo($photo)?>">
            
            <button type="submit" style="align-self: center; width: 50%">Update</button>
        </form>
    </div>
</body>
</html>